  ...
  const onSubmit = () => {
    emailjs
      .sendForm(
        ...
        "template_t44ybek",
        fromRef.current,
        "user_tgsfRKXHSudANgSVs0uRe"
      )
      .then(
        () => {
          swal(
            "Message sended!",
            "Your message successfully sended!",
            "success"
          );
        ...
        () => {
          swal(
            "Message Not sended!",
            "Your message not sended. Try again Latter!",
            "error"
          );
          fromRef.current.reset();
        }
            ...
            <div data-aos="flip-down" className="col-lg-6">
              ...
              >
                <div className="col-md-6">
                  <label className="mb-2 ms-2" htmlFor="">
                    Name
                  </label>
                  <input
                  ...
                  />
                  {errors.name && (
                    <span className="alert-danger p-1 rounded d-inline-block mt-2">
                      Name is required
                    </span>
                  )}
                </div>
                ...
                <div className="col-md-6">
                  <label className="mb-2 ms-2" htmlFor="">
                    Address <span className="muted-text">(Optional)</span>
                  </label>
                  <input
                    type="text"
                    className="form-control radius"
                ...
                <div className="col-12">
                  ...
                  {errors.message && (
                    <span className="alert-danger p-1 rounded d-inline-block mt-2">
                      Message is required minimum 10 character
                    </span>
                  )}
                </div>
                <div>
