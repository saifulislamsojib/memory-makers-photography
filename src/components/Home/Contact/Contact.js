                        ...
                        <div data-aos="flip-down" className="col-lg-6">
                            <form className="row g-3 mt-3" onSubmit={handleSubmit(onSubmit)} ref={fromRef} >
                                <div className="col-md-6">
                                    ...
                                    {errors.name && <span className="error d-inline-block mt-2">Name is required</span>}
                                </div>
                                <div className="col-md-6">
                                    <label className='mb-2 ms-2' htmlFor="">Email</label>
                                    <input defaultValue={loggedInUser.email} type="email" className="form-control radius" placeholder="Email" {...register("email", { required: true })} name="email" />
                                    {errors.email && <span className="error d-inline-block mt-2">Email is required</span>}
                                </div>
                                <div className="col-md-6">
                                    ...
                                    {errors.phone && <span className="error d-inline-block mt-2">Phone Number is required</span>}
                                </div>
                                <div className="col-md-6">
                                ...
                                <div className="col-12">
                                    ...
                                    {errors.message && <span className="error d-inline-block mt-2">Message is required minimum 10 character</span>}
                                </div>
                                <div>
